...
class DataService {
   Future insertKeuangan(String appid, String name, String description, String amount, String type, String category, String date, String picture) async {
      String uri = 'https://io.etter.cloud/v4/insert';

      try {
         final response = await http.post(Uri.parse(uri), body: {
            'token': '6717db9aec5074ec8261d698',
            'project': 'uts-remedial',
            'collection': 'keuangan',
            'appid': appid,
            'name': name,
